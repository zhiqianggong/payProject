        ...
        <el-card class="box-card">
          ...
          <el-row :gutter="10">
            <el-form :model="changeMecFrom">
              <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
                <el-form-item label="用户ID" label-width="130px" class="reset-select">
                  <el-input disabled v-model="changeMecFrom.userId"></el-input>
                </el-form-item>
              </el-col>
              <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
        ...
        .then((res) => {
          if (res.data.code == 200) {
            ...
            this.changeMecFrom = {
              ...
              isSuperAdmin: String(this.dataList.isSuperAdmin),
