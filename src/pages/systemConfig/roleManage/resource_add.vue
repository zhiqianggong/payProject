            ...
            <el-form :model="changeMecFrom">
              ...
              <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
                <el-form-item label="资源标题" label-width="130px">
                  <el-input v-model="changeMecFrom.title"></el-input>
                </el-form-item>
              </el-col>
              <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
                <el-form-item label="资源类型" label-width="130px">
                  <el-radio-group v-model="changeMecFrom.type">
              ...
              <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
                <el-form-item label="所属系统" label-width="130px">
                  <el-radio-group v-model="changeMecFrom.system">
              ...
              <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
                <el-form-item label="排序值" label-width="130px">
                  <el-input v-model="changeMecFrom.orderNum"></el-input>
                </el-form-item>
              </el-col>
              <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
      ...
      this.axios({
        ...
        data: {
          body: {
            ...
            parentId: this.$route.query.id ? this.$route.query.id : this.changeMecFrom.parentId,
