...
export default {
  ...
  methods: {
    ...
    addType() {
      this.$router.push("add_payment");
    },
    modify(row) {
      this.$router.push({ name: "payment_modify", query: { id: row.id } });
    },
    riskSet(row) {
      this.$router.push({ name: "payment_risk_set", query: { id: row.id } });
    },
    subAccount(row) {
      this.$router.push({ name: "payment_sub_account", query: { id: row.id } });
    }
  },
  created() {
    this.getTableData();
