      ...
      <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
        <el-card class="box-card reset-card">
          ...
          <el-table ref="table" :data="tableData" style="width: 100%;" v-loading="loading" border>
            <el-table-column prop="payTypeCode" label="支付类型代码" min-width="100"></el-table-column>
...
export default {
  ...
  methods: {
      ...
      this.axios({
        ...
        .then((res) => {
          ...
          if (res.data.code == 200) {
            this.tableData = res.data.body.payTypeList;
    ...
    changeSwitch(row) {
      this.axios({
        method: "post",
        url: "/api/config/pay_type/update",
        data: {
          body: {
