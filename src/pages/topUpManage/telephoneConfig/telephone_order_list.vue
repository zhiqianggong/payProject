...
export default {
  ...
  methods: {
    ...
    addType() {
      this.$router.push("add_telephone");
    },
    modify(row) {
      this.$router.push({ name: "telephone_modify", query: { id: row.id } });
    },
    riskSet(row) {
      this.$router.push({ name: "telephone_risk_set", query: { id: row.id } });
    },
    subAccount(row) {
      this.$router.push({ name: "telephone_sub_account", query: { id: row.id } });
    }
  },
  created() {
    this.getTableData();
